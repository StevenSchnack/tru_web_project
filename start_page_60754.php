...
<head>
    ...
    <div id="div-start-header" class="container-fluid p-5 text-bg-dark rounded-0 rounded-bottom">
...
<body>
    ...
    <div id="div-body-content">
        <div id="div-start-content" class="container">
            <div class="row">
                <img src="">
            </div>
            <div class="row justify-content-center row-cols-2 pt-5">
                <input id="button-login" type="button" class="btn btn-primary btn-lg" value="Login">
            </div>
            <div class="row justify-content-center row-cols-3 pt-3">
